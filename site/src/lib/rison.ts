// The following code is appropriated from https://github.com/Nanonid/rison, which was distributed
 ...
 *
 */
const uri_ok = {  // ok in url paths and in form query args
...
let idrx = '[^' + not_idstart + not_idchar + '][^' + not_idchar + ']*';
 ...
 *
 */
export function encode_object(v) {
 ...
 *
 */
export function encode_array(v) {
 ...
 */
export function decode_object(r) {
    return decode('('+r+')');
};
 ...
 */
export function decode_array(r) {
    return decode('!('+r+')');
};
